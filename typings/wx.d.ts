// generate time:2018-8-3 06:00:16 
...
declare var wx: {
     ...
     * @param param
     */
    navigateTo(param: { url: string }): void;

    /**
     *选择图片
     * @param param
     */
    chooseImage(param: { sizeType: string[]; sourceType: string[]; count: number; success: void; fail: void; complete: void }): void;

    /**
     * 显示正在加载
     * @param param
     */
    showLoading(param: { title: string; mask: boolean; success: void; fail: void; complete: void }): void;
     ...
     * @param param
     */
    login(param: { timeout: number, success: void, fail: void, complete: void }): void;

    /**
     * 微信获取用户信息
     * @param param
     */
    getUserInfo(param: { fail: void; success: void }): void;

    /**
     * 调起用户编辑收货地址原生界面，并在编辑完成后返回用户选择的地址。
     * @param param
     */
    chooseAddress(param: { success: void; fail: void }): void;
}